      // 选择查询后分页
      var commandTypeSearch,boardSizeSearch,content = null;
      $('.search').bind('click',function(){
      	commandTypeSearch = $('#commandType').val();
      	boardSizeSearch = $('#boardSizeSearch').val();
      	content = $('.contentSearch').val();
        informationBase(1,size,commandTypeSearch,boardSizeSearch,content);  
      });
        var nowNum;
        var coefficient = 0.7;
		function informationBase(num,size,commandType,boardSize,content) {
			console.log(num);
			console.log(size);
			...
			nowNum = num;
			$.ajax({
				url: "/informationBoard/informationBaseData",
				type: "get",
				dataType: "json",
				data:{
					'page':num-1,
				...
				success: function(data) {
					...
					$("#page").paging({
						...
						callback: function(num) {
							informationBase(num,size,commandType,boardSize,content);
						}
					})
				},
				error:function(data) {
   ...
   function informationBoardDelete(deleteId){
   		$.ajax({
            ...
            success:function(res){
	            ...
	            informationBase(nowNum,size,commandTypeSearch,boardSizeSearch,content);    
